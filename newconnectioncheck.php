      ...
      <div class="container">
          ...
          <div class="card-body">
            ...
            <div class="card-body">
                ...
                <div class="col-xs-12">
                   <input type="id" id="inputid" class="form-control" name="nic" required="" placeholder="Enter Your National IC No." autofocus=""></br> 
...
echo "<script>window.open('newconnectioncheck1.php?nic=".$nic."','_self')</script>";
