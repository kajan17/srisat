...
?>
      ...
      ?>
          ...
          <thead>
                  ...
                  <tbody>
                    <?php
        include("database/db_conection.php");
        $view_users_query="select * from tvconnection,newconnectioncard where tvconnection.nicnumber= newconnectioncard.nicno && vcnumber<>'0'";//select query for viewing users.
        $run=mysqli_query($dbcon,$view_users_query);//here run the sql query.
 ...
 include('edit_modal.php');
                 ...
                 <?php }else if($partialstatus=='0' && $finishstatus=='0'){?>
                               ...
                               <?php echo "<td><a href='#edit_".$connectionid."' class='btn btn-success btn-sm' data-toggle='modal'><span class='glyphicon glyphicon-edit'></span> DO JOB</a></td>";  ?>
                      <?php
                include('edit_modal.php');
