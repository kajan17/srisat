    ...
    $connectionID = $_GET['connection1'];}
      ?>
            <div class="card-header">
              ...
              NEW CONNECTION PARTILAY FINISHED REPORT</div>
            <div class="card-body">
              <form class="form-signin" role="form" method="post" action="repaircomplaientspartialmodel.php">
               
                 <input name="connectionid" type="hidden" class="form-control" value="<?php echo $connectionID; ?>">
              <select class="form-control" name="comment" data-bv-notempty data-bv-notempty-message="" autofocus="" required="">
                            ...
                            <option value="Low Signal">Receiver Defect</option>
                            <option value="Low Signal">LMP Defect</option>
             </select> </br>
             <button type="reset" class="btn btn-success" value="Reset">Reset</button>
              <button type="submit" name="partial" class="btn btn-success"><span class="glyphicon glyphicon-check"></span> OK</button>
           </form>
              </div>
            </div>
