      ...
      ?>
          ...
          <thead>
                  ...
                  <tbody>
                    <?php
        include("database/db_conection.php");
        $view_users_query="select * from customer,carduser where customer.customerID= carduser.customerID && carduser.installationmethode='srisat'";//select query for viewing users.
        $run=mysqli_query($dbcon,$view_users_query);//here run the sql query.
        ...
        ?>
                   ...
                   <?php }else if($partialstatus=='1'){?>
                      ...
                      <?php echo "<td><a href='#sris_".$connectionid."' class='btn btn-warning btn-sm' data-toggle='modal'><span class='glyphicon glyphicon-edit'></span> PARTIALLY DONE</a></td>"; 
