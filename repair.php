...
?>
   <option value='<?php echo $vcno;?>' > <?php echo $vcno;?> => Subscriber = <?php echo $vender;?></option></br>
        ...
        <div class="media text-muted pt-3">
          ...
          <p class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
            ...
            <input type="text" class="form-control" name="errorcode" autofocus="" placeholder="Eg:- e50-32 OR Type the problem"  value="">
          </p>
        </div>
